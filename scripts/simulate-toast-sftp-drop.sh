...
SRC_CSV="${2:-$ROOT/data/toast/pos/$LOCATION/ItemSelectionDetails_2026_04_01-2026_04_30.csv}"
...
echo "  psql \$DATABASE_URL -c \"INSERT INTO recipe_lines (location_id, menu_item_id, inventory_item_id, qty_per_serving, waste_factor) VALUES ('$LOCATION', 'MENU_ID', 'INVENTORY_ID', 0.5, 0) ON CONFLICT DO NOTHING;\""
